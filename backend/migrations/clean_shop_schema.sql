-- Supabase SQL Schema for Shop With Us Section
...
((SELECT id FROM policy_categories WHERE name = 'returns'), '30-Day Hassle-Free Returns', 'Return any item within 30 days of delivery. Free pickup service available from your home. Instant refund processing within 24 hours of pickup.', 'fa-rotate-left', '{"window": 30, "free_pickup": true, "instant_refund": true, "condition": "original_packaging_required"}', true, true);