module.exports = {
	...
	animation: {
		'brutalist-jitter': 'brutalist-jitter 0.3s ease-in-out',
		'brutalist-fadeIn': 'brutalist-fadeIn 0.6s ease-out',
		'brutalist-scale': 'brutalist-scale 0.4s ease-in-out infinite',
		'brutalist-bounce': 'brutalist-bounce 1s ease-in-out infinite',
		'brutalist-pulse': 'brutalist-pulse 2s ease-in-out infinite',
		'animate-gradient': 'gradient-shift 15s ease infinite',
	...
	// ✅ Fixed: Added all custom utility definitions and animations
// shadow-glass, shadow-brutalist, animate-brutalist-*, hover-brutalist, btn-brutalist, card-brutalist, etc.
