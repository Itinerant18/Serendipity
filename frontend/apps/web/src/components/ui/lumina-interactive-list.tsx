  ...
  useEffect(() => {
    ...
    const initApplication = async () => {
        ...
        const slides = [
            ...
            { title: "Beauty", description: "Enhance your natural beauty.", media: "https://img.freepik.com/free-photo/monochrome-beauty-product-skincare_23-2151307223.jpg?semt=ais_hybrid&w=740&q=80", link: "/category/Beauty" },
            { title: "Sports", description: "Gear up for performance with high-quality sports equipment.", media: "https://harvardindependent.com/wp-content/uploads/2019/05/Crew-Article_Andrew_Nick-1024x731.jpg", link: "/category/Sports" },
