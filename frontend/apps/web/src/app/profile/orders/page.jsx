            ...
            <div className="flex gap-2 flex-wrap">
                {["all", "pending", "processing", "shipped", "delivered", "cancelled"].map((status) => (
                    <button
                        ...
                        className={`px-4 py-2 rounded-lg text-sm font-medium capitalize transition-all duration-300 cursor-pointer hover:scale-105 ${filter === status
                ...
                <div className="space-y-4">
                    {filteredOrders.map((order, index) => {
                        ...
                        return (
                            <div
                                key={order.id}
                                className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden transition-all duration-300 hover:shadow-lg hover:border-orange-200 hover:-translate-y-1 group cursor-pointer animate-fade-in-up"
