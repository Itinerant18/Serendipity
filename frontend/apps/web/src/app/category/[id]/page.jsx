...
export default function CategoryPage() {
    ...
    const fetchProducts = async () => {
        setLoading(true);
        try {
            const response = await fetch(`${import.meta.env.VITE_API_URL || (import.meta.env.VITE_API_URL || 'http://localhost:5000')}/api/products?category=${encodeURIComponent(categoryName)}&limit=100`);
